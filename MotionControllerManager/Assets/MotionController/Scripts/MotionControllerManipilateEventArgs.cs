...
namespace Assets.MotionControl.Scripts
{
    ...
    {
        public class MotionControllerManipilateEventArgs : MotionControllerEventArgs
        {
            public MotionControllerManipilateEventArgs(InteractionSourceState sourceState, Vector3 pointerPosition, Quaternion pointerRotation, Vector3 controllerPosition, Quaternion controllerRotation, InteractionSourceHandedness handedness) : base(
